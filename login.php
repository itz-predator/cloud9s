    ...
    <div class="container">
        ...
        <form action="phpScript/login.php" method="post">
            ...
            <div class="form-item">
                ...
                <input type="text" name="email" id="text" placeholder="username or email">
            </div>
            ...
            <button type="submit" formaction="phpScript/login.php"> LOGIN </button>
			<center><a href="index.php"><button type="button"><h4 style="color:yellow;">Back To Home </h4></button></a></center>
        </form>
