            ...
            <ul class="nav navbar-nav navbar-right">
			    <li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						<li class="m_2"><a href="phpScript/logout.php"><i class="fa fa-lock"></i> Logout</a></li>	
	        		</ul>
	      		</li>
			</ul>
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="phpScript/logout.php"><i class="fa fa-sign-out fa-fw nav_icon"></i>Logout</a>
                            <!-- /.nav-second-level -->
                        </li>
                    </ul>
                </div>
     	...
     	<div class="col_3">
			<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
				<div class="panel-body no-padding">
					...
					<center><h2>Total Deactivated User</h2></center>
						<thead>
							<tr class="warning">
								<th>No.</th>
								<th>User Id</th>
						...
						<tbody>
							<?php 
								...
								<tr>
									...
									<td><?=$r['gender']?></td>
									<td>
										<form method="post" action="phpscript/activated.php">
										<input type="hidden" name="uid" value="<?=$r['id']?>">
										<button class="btn btn-info" name="Activate">Activate</button>
									</form>
									</td>
								 </tr>
								 <?php $i++;} ?>
